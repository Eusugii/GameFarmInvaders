...
class enemy(object):
    ...
    attackFront= [pygame.image.load('images/enemy/a1.png'),pygame.image.load('images/enemy/a2.png'),pygame.image.load('images/enemy/a3.png'),pygame.image.load('images/enemy/a4.png'),pygame.image.load('images/enemy/a5.png'),pygame.image.load('images/enemy/a6.png'),pygame.image.load('images/enemy/a7.png'),pygame.image.load('images/enemy/a8.png'),pygame.image.load('images/enemy/a9.png'),pygame.image.load('images/enemy/a10.png'),pygame.image.load('images/enemy/a11.png'),pygame.image.load('images/enemy/a12.png')]
    ...
    #values for dead animation
        ...
        self.deadx =0 
        self.deady =0
    #values for attack animation
        self.attack_counter = 0
        self.attack = False
        self.attackx =0 
        self.attacky =0

    def draw(self,win,deadx,deady):#the dead parameters are used for dead and attack animation
        self.move()
        ...
        if self.attack:
            if self.attack_counter +1 >=36:
                win.blit(self.attackFront[11],(deadx,deady))
                self.attack_counter =0
                self.attack = False
            else:
                win.blit(self.attackFront[self.attack_counter//3],(deadx,deady))
